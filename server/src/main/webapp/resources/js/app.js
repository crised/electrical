...
(function() {
	...
	// The module is accessible everywhere using "angular.module('app')",
	// therefore global variables can be avoided totally.
	as = angular.module('app', [ 'app.controllers', 'app.services',
			'app.directives' ]);
